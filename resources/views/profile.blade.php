            ...
            <div class="col-lg-12 mb-4">
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <div class="row">
                            <img src="{{$schoolInformation->school_profile_image !== null || $schoolInformation->school_profile_image !='' ? url('uploads/'.$schoolInformation->school_profile_image) : asset('my-register/img/The-Register.jpg') }}" width=200 height=150 class="offset-md-1 col-md-2 offset-sm-1 col-sm-2 img-responsive img-rounded">
                            <div class=" col-md-4 offset-sm-1 col-sm-4">
                                 ...
                                 <p class="m-3" ><i class="fa fa-map-marker text-danger"> </i> <i> 7 Rahaman Street Olambe Ogun State</i> </p>
                            </div>
